...
**GitHub:** https://github.com/srodrift/proof
**Demo:** `npm start` → http://localhost:3000/proof.html
**Pipe:** `gtm_discovery.pipe` (attached / in repo root)

**Stack:** RocketRide · Cognee · HydraDB · Hotdata (one DB per experiment, in parallel) · Modiqo · Snyk

**Demo beat:** Run 1 explores Relay → you downgrade Hacker News → promote the play → Run 2 replays on Ledgerline. Scoreboard shows measured calls and time, not hardcoded numbers.

Tracks: Main · Multi-agent / Hotdata · RocketRide
